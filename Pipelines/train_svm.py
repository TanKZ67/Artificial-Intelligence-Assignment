...
print(f"SVM Pipeline: Found {len(labels)} classes. Extracting landmarks...", flush=True)
...
print("\n--- Training SVM Model (RBF Kernel) ---", flush=True)
...
joblib.dump(svm_model, os.path.join(save_dir, "asl_svm_model.pkl"))
print("✅ Saved to Models/asl_svm_model.pkl")